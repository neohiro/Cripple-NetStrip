...
datas = [('netstrip/data/lists', 'netstrip/data/lists'), ('netstrip/data/updater_sources.json', 'netstrip/data'), ('assets', 'assets/')]
binaries = []
...
tmp_netstrip = collect_all('netstrip')
datas += tmp_netstrip[0]; binaries += tmp_netstrip[1]; hiddenimports += tmp_netstrip[2]
