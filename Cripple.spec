...
datas = [('C:\\Users\\skele\\AppData\\Local\\Programs\\Python\\Python312\\Lib\\site-packages\\customtkinter', 'customtkinter/'), ('netstrip/data/lists', 'netstrip/data/lists'), ('netstrip/data/updater_sources.json', 'netstrip/data'), ('assets', 'assets/')]
binaries = []
