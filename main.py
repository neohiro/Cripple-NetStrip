        ...
        try:
            ...
            if "--block" in sys.argv:
                ...
                if "--force" not in sys.argv:
                    ...
                    print("  ╠══════════════════════════════════════════════════════╣")
                    print("  ║  Drops all network traffic with smart exceptions.   ║")
                    print("  ║                                                      ║")
                    print("  ║  • Most connections will be severed                  ║")
                    print("  ║  • User whitelists and preferences ARE honored      ║")
                    print("  ║  • SSH may survive if explicitly whitelisted        ║")
                    print("  ║  • Remote recovery via --unghost is possible        ║")
                    print("  ║                                                      ║")
