        ...
        try:
            ...
            if "--block" in sys.argv:
                ...
                if "--force" not in sys.argv:
                    print("")
                    print("  ╔══════════════════════════════════════════════════════╗")
                    print("  ║  ⚠  MASTER KILLSWITCH — DANGER                     ║")
                    print("  ╠══════════════════════════════════════════════════════╣")
                    print("  ║  This will DROP ALL network traffic immediately.    ║")
                    print("  ║                                                      ║")
                    print("  ║  • All active connections will be severed            ║")
                    print("  ║  • SSH and remote terminals will disconnect          ║")
                    print("  ║  • VPN tunnels will be destroyed                     ║")
                    print("  ║  • If you are remote, you WILL be locked out        ║")
                    print("  ║                                                      ║")
                    print("  ║  To recover: physical access or --unkillswitch      ║")
                    print("  ╚══════════════════════════════════════════════════════╝")
                    print("")
                ...
                if "--force" not in sys.argv:
                    print("")
                    print("  ╔══════════════════════════════════════════════════════╗")
                    print("  ║  ☠  GHOST MODE — TOTAL NETWORK ISOLATION            ║")
                    print("  ╠══════════════════════════════════════════════════════╣")
                    print("  ║  This is MORE EXTREME than the killswitch.          ║")
                    print("  ║                                                      ║")
                    print("  ║  • ALL traffic dropped INCLUDING loopback           ║")
                    print("  ║  • ALL network interfaces will be disabled          ║")
                    print("  ║  • SSH, VNC, and ALL remote access will die         ║")
                    print("  ║  • IPC commands may stop working                    ║")
                    print("  ║  • The device becomes a TRUE GHOST on the network   ║")
                    print("  ║                                                      ║")
